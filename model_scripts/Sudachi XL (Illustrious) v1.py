#@title Sudachi XL (Illustrious) v1
...
!wget -O "models/Stable-diffusion/CivitaiModel1453425_fp16.safetensors" "https://civitai.com/api/download/models/1453425?type=Model&format=SafeTensor&size=pruned&fp=fp16"
