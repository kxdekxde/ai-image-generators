#@title Plant Milk Walnut (ymk3.0.0)
...
!wget -O "models/Stable-diffusion/CivitaiModel1714002_fp16.safetensors" "https://civitai.com/api/download/models/1714002?type=Model&format=SafeTensor&size=pruned&fp=fp16"
